...
function App() {
  return (
    <div className="container">
      ...
      <div className="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3">
        ...
        >
          <div className="my-3 py-3">
            <h3 className="display-5">Same Day/Next Day Service</h3>
            <p className="lead"></p>
          </div>
          <div
      ...
      <div className="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3 ">
        <div
          className="mr-md-3  px-md-5 text-center text-black overflow-hidden"
          id="icons"
        >
          <svg className="svg-icon-b" viewBox="0 0 20 20">
            <path
              fill="black"
          ...
          <h6 className="svgTags">Flexible Scheduling</h6>

          <svg class="svg-icon-b" viewBox="0 0 20 20">
          ...
          <h6 className="svgTags">Quick Service</h6>

          <svg
            className="svg-icon-b"
